...
// ignore: prefer_final_fields
  List<Question> _questions = [
    Question(
      id: '1',
      title: 'Kết quả 2 + 2 = ?',
      options: {'A. 5': false, 'B. 10': false, 'C. 4': true, 'D. 8': false},
      answer: 'C',
    ),
    Question(
      id: '2',
      title: 'Kết quả 2 x 5 = ?',
      options: {'A. 5': false, 'B. 10': true, 'C. 4': false, 'D. 8': false},
      answer: 'B',
    ),
    Question(
      id: '3',
      title: 'Kết quả 5 - 5 = ?',
      options: {'A. 3': false, 'B. 2': false, 'C. 1': false, 'D. 0': true},
      answer: 'D',
    ),
    Question(
      id: '4',
    ...
    Question(
      ...
      options: {'A. 5': false, 'B. 10': false, 'C. 0': true, 'D. 8': false},
      answer: 'C',
    ),
    Question(
      id: '6',
    ...
    Question(
      id: '9',
      title: 'Kết quả 2 - 2 x 0= ?',
      options: {'A. 6': false, 'B. 4': false, 'C. 2': true, 'D. 8': false},
      answer: '',
    ),
    Question(
      id: '10',
