...
// ignore: prefer_final_fields
  List<Question> _questions = [
    Question(
      ...
      options: {
        'A. một quốc gia độc lập, có chủ quyền': true,
        'B. một vùng tự trị của Trung Hoa': false,
        'C. một quốc gia tự do': false,
        'D. một vùng ảnh hưởng của Trung Hoa': false
      },
      answer: 'A',
    ),
    Question(
      ...
      options: {
        'A. hình thành và hoàn thiện mô hình bước đầu': false,
        'B. đang ở trong giai đoạn khủng hoảng suy yếu nghiêm trọng': true,
        'C. được củng cố vững chắc và phát triển hưng thịnh': false,
    ...
    Question(
      ...
      options: {
        'A. Khởi nghĩa Ba Đình': false,
        'B. Khởi nghĩa Bãi Sậy': false,
        'C. Khởi nghĩa Hùng Lĩnh': false,
        'D. Khởi nghĩa Hương Khê': true
      },
      answer: 'D',
    ),
    Question(
      ...
      options: {
        'A. Chương trình khai thác thuộc địa lần thứ nhất của thực dân Pháp':
            true,
        'B. Chiến tranh thế giới thứ nhất bùng nổ': false,
        'C. Thực dân Pháp hoàn thành quá trình bình định Việt Nam': false,
        'D. Tư tưởng dân chủ tư sản được du nhập vào Việt Nam': false
      },
      answer: 'A',
    ),
    Question(
      ...
      options: {
        ...
        'C. Ưu thế của Pháp ở Việt Nam khi giành thắng lợi ở chiến tranh Canada':
            false,
        'D. Do sự giàu có về tài nguyên của Việt Nam': false
      },
      answer: 'C',
    ),
    Question(
      ...
      options: {
        'A. Cuộc kháng chiến diễn ra thiếu sự chuẩn bị chu đáo': false,
        'B. Không tập hợp đoàn kết được đông đảo nhân dân tham gia đấu tranh':
            false,
        'C. So sánh tương quan lực lượng chênh lệch bất lợi cho Việt Nam': true,
        'D. Thiếu sự đoàn kết quốc tế': false
      },
      answer: 'C',
    ),
    Question(
      ...
      options: {
        'A. Là một nước phụ thuộc vào thực dân Pháp': false,
        'B. Là một nước thuộc địa': false,
        'C. Là một nước thuộc địa nửa phong kiến': true,
        'D. Là một nước nửa thuộc địa nửa phong kiến': false
      },
      answer: 'C',
    ),
    Question(
      ...
      options: {
        'A. Phong trào Cần Vương': true,
        'B. Phong trào nông dân Yên Thế': false,
        'C. Cuộc đấu tranh của đồng bào dân tộc thiểu số': false,
        'D. Khởi nghĩa Thái Nguyên': false
      },
      answer: 'A',
    ),
    Question(
      ...
      options: {
        'A. Khởi nghĩa Hương Khê': false,
        'B. Khởi nghĩa Yên Thế': true,
        'C. Khởi nghĩa ở vùng Tây Bắc và hạ lưu sông Đà': false,
        'D. Khởi nghĩa của đồng bào Tây Nguyên': false
      },
      answer: 'D',
    ),
    Question(
      ...
      options: {
        'A. Giành độc lập dân tộc theo con đường dân chủ tư sản': false,
        'B. Diễn ra theo 2 phương pháp: bạo động và cải cách': false,
        'C. Đều bị thực dân Pháp đàn áp': false,
        'D. Do tầng lớp tư sản, tiểu tư sản lãnh đạo': true
      },
      answer: 'D',
    ),
  ];
